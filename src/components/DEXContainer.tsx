    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-6">
        <div className="glass card-hover rounded-2xl p-12 max-w-2xl mx-auto text-center">
          ...
          <p
            className="mb-8 text-lg leading-relaxed max-w-lg mx-auto"
            style={{ color: "rgba(251, 250, 249, 0.8)" }}
          >
            The most intuitive decentralized exchange on Monad. Swap tokens,
            provide liquidity, and earn rewards with minimal fees and maximum
            efficiency.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              <TrendingUp
                ...
                style={{ color: "#836EF9" }}
              />
              <h3 className="font-semibold mb-2" style={{ color: "#FBFAF9" }}>
                Instant Swaps
              </h3>
              <p
                className="text-sm"
          ...
          <div className="flex justify-center items-center space-x-8 text-sm mb-8">
            <div className="flex items-center space-x-2">
              ...
              ></div>
              <span style={{ color: "rgba(251, 250, 249, 0.8)" }}>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center space-x-4 text-sm">
              <span style={{ color: "rgba(251, 250, 249, 0.6)" }}>
                Supported:
              </span>
