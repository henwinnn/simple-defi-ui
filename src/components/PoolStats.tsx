...
const PoolStats = () => {
  ...
  const reserveAFormatted = formatBigInt(
    poolInfo.reserveA,
    TOKENS.CAMP.decimals,
    2
  );
  const reserveBFormatted = formatBigInt(
    poolInfo.reserveB,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gradient-monad mb-2">
          Pool Statistics
        </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="w-full bg-white/10 rounded-full h-2">
              <div
                ...
                style={{
                  width:
                    totalTVL > 0 ? `${(campValue / totalTVL) * 100}%` : "50%",
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgba(131, 110, 249, 0.3), transparent)",
                  }}
                ></div>
              </div>
            </div>
            <div
              ...
              style={{ color: "rgba(251, 250, 249, 0.6)" }}
            >
              {totalTVL > 0
                ? `${((campValue / totalTVL) * 100).toFixed(1)}%`
                : "50%"}{" "}
              of pool
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="w-full bg-white/10 rounded-full h-2">
              <div
                ...
                style={{
                  width:
                    totalTVL > 0 ? `${(usdcValue / totalTVL) * 100}%` : "50%",
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgba(160, 5, 93, 0.3), transparent)",
                  }}
                ></div>
              </div>
            </div>
            ...
            >
              {totalTVL > 0
                ? `${((usdcValue / totalTVL) * 100).toFixed(1)}%`
                : "50%"}{" "}
              of pool
            </div>
          </div>
