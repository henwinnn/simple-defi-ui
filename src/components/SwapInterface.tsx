  ...
  return (
    <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl mx-auto px-4 sm:px-0">
      <div className="glass rounded-2xl p-4 sm:p-6 lg:p-8 card-hover border border-white/10 shadow-2xl">
        ...
        <div className="space-y-3 sm:space-y-4 mb-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div
                  className="flex-1 text-lg sm:text-2xl font-bold min-w-0 truncate"
                  style={{ color: "#FBFAF9" }}
                >
                  {swapData?.amountOut || "0.0"}
                </div>
                <div
                  className="flex items-center gap-1 sm:gap-2 p-2 rounded-xl border flex-shrink-0"
                  style={{
        ...
        {swapData && (
          <div
            className="mb-4 sm:mb-6 p-3 sm:p-4 rounded-xl border space-y-2"
            style={{
          ...
          >
            <div className="flex justify-between text-xs sm:text-sm">
              ...
              <span
                style={{ color: getPriceImpactColor(swapData.priceImpact) }}
              >
            ...
            {swapData.priceImpact > 3 && (
              <div
                className="flex items-start gap-2 p-2 sm:p-3 rounded border"
                style={{
        ...
        <button
          ...
          style={{
            background:
              !swapData || isSwapping || isInsufficientBalance()
